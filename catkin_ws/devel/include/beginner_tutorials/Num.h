...
struct Num_
{
  ...
  _num_type num;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _Michelle_type;
  _Michelle_type Michelle;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _Wang_type;
  _Wang_type Wang;
...
struct MD5Sum< ::beginner_tutorials::Num_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x45a383feccb5e81eULL;
  static const uint64_t static_value2 = 0x4f1f19f51b552094ULL;
};
...
struct Printer< ::beginner_tutorials::Num_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::beginner_tutorials::Num_<ContainerAllocator>& v)
  {
    ...
    s << indent << "Michelle: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.Michelle);
    s << indent << "Wang: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.Wang);
    s << indent << "age: ";
